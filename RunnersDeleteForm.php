               ...
               <div class="panel-body">
                  <form class="form-horizontal" role="form" method="post" action="RunnersDeleteHandler.php">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                           <input type="text" class="form-control" id="school_name" name="school_name" value=<?php echo "\"" . $school_name . "\"" ?> disabled>
                        </div>
                     </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                           <input type="number" class="form-control" id="grade" name="grade" value=<?php echo "\"" . $grade . "\"" ?> disabled>
                        </div>
                     </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                           <label class="radio-inline">
                              <input type="radio" name="sex" value="M" disabled <?php echo $maleSelected ?>>Male
                           </label>
                           <label class="radio-inline">
                              <input type="radio" name="sex" value="F" disabled <?php echo $femaleSelected ?>>Female
                           </label>
                        </div>
                     </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                           <input type="text" class="form-control" id="race" name="race" value=<?php echo "\"" . $race_description . "\"" ?> disabled>
                        </div>
                     </div>
