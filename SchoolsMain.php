   ...
   <div class="container">
      <div class="row">
         <div class="col-xs-12">
            ...
            <div class="btn-group">
               <a class="btn btn-primary" href="SchoolsEmailRosterSummaryHandler.php">Email Roster Summary</a>
            </div>
         </div>
      </div>
      <div class="row"></br>
               ...
               <div class="panel-body">
                  <form class="form-horizontal" role="form" method="post" action="SchoolsAddHandler.php">
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                           <input type="text" class="form-control" maxlength="50" id="school_name" name="school_name" placeholder="Unique School Name (50 chars max)" required>
                        </div>
                     </div>
                     <hr />
