               ...
               <div class="panel-body">
                  <form class="form-horizontal" role="form" method="post" action="UserChangePasswordHandler.php">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-6">
                           <input type="password" name="current_password" class="form-control" id="current_password" value="" required>
                        </div>
                     </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-6">
                           <input type="password" name="new_password" class="form-control" id="new_password" value="" pattern="[A-Za-z0-9@#$%]{4,10}" title="4 to 10 alphanumeric characters, incuding @, #, $, %" required>
                        </div>
                     </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-6">
                           <input type="password" name="new_password_confirm" class="form-control" id="new_password_confirm" value="" pattern="[A-Za-z0-9@#$%]{4,10}" title="4 to 10 alphanumeric characters, incuding @, #, $, %" required>
                        </div>
                     </div>
                     <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-6">
                           <input type="checkbox" value="emailpassword" id="emailpassword" name="emailpassword">
