...
<body>
   ...
   if ($sex == RunnerSexValues::Boy) {
      $boySelected = "checked";
   } else {
      $girlSelected = "checked";
   }
                  ...
                  <div class="col-xs-6 col-xs-offset-3">
                     <div class="panel panel-primary">
                        <div class="panel-heading">
                           <strong class="">Modify Race</strong>
                        </div>
                        <div class="panel-body">
                           <form class="form-horizontal" role="form" method="post" action="RacesModifyHandler.php">
                              <div class="form-group">

                                 <input type="hidden" id="race_id" name="race_id" value=<?php echo "\"" . $race_id . "\"" ?>>

                                 <label for="distance" class="col-sm-4 control-label">Distance</label>
                                 <div class="col-sm-8">
                                    <input type="number" class="form-control" name="distance" value=<?php echo "\"" . $distance . "\"" ?> id="distance" placeholder="Distance" step=0.01 autofocus required>
                                 </div>
                              </div>
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-8">
                                    <label class="radio-inline"><input type="radio" name="sex" value="<?php echo RunnerSexValues::Boy; ?>" <?php echo $boySelected ?> required>Boy</label>
                                    <label class="radio-inline"><input type="radio" name="sex" value="<?php echo RunnerSexValues::Girl; ?>" <?php echo $girlSelected ?> required>Girl</label>
                                 </div>
                              </div>
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-8">
                                    <input type="text" class="form-control" name="qual_time" id="qual_time" value=<?php echo "\"" . $qual_time . "\"" ?>placeholder="Qualifying Time (hh:mm:ss)" pattern="[0-9][0-9]:[0-9][0-9]:[0-9][0-9]" autofocus required>
                                 </div>
                              </div>
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-8">
                                    <input type="text" class="form-control" name="description" value=<?php echo "\"" . $description . "\"" ?> id="description" placeholder="Description (e.g. Boys 1.0 Mile)" maxlength=25 required>
                                 </div>
                              </div>
                              <hr />
