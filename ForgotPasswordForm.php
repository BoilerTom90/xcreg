    ...
    <div class="row">
        ...
        <div class="col-xs-6 col-md-offsetx-7">
            <div class="panel panel-primary">
                <div class="panel-heading"> <strong class="">Forgot Password</strong><br>
                <em style="font-size:smaller">Enter your email address</em>
                </div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="post" action="ForgotPasswordFormHandler.php">
...
<script type="text/javascript">
   ...
   var siteKey = '6LfrwG0UAAAAACPLFc4VO6t0DlElZhF6_8VK0mQg';
