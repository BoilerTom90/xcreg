...
function DisplayAdminLevelNavBar($requestingPageName)
{
      ...
      $pendingUsersObj = new PendingUsersTable();
      $pendingUsersRecs = $pendingUsersObj->ReadAll();
      $numPendingUsers = count($pendingUsersRecs);
      $pendingUsersCountText = "";
      if ($numPendingUsers) {
         $pendingUsersCountText = "<span class='badge'>" . $numPendingUsers . "</span>";
      }
		...
		<nav class="navbar navbar-inverse" style="margin-bottom:0">  
			<div class="container-fluid">
               ...
               <ul class="nav navbar-nav navbar-left">
                  ...
                  <li $pagePendingUsersClass><a href="PendingUsersForm.php">PendingUsers $pendingUsersCountText</a></li>
...
function DisplayUserLevelNavBar($requestingPageName)
{
   	...
   	switch ($requestingPageName) {
		...
		case "AllRunners":
   			$pageViewAllRunnersClass = "class='active'";
            break;
...
<nav class="navbar navbar-inverse" style="margin-bottom:0">  
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
         <ul class="nav navbar-nav navbar-left">
            <li $pageRunnersClass><a href="RunnersMain.php">My Runners</a> </li>
            <li $pageViewAllRunnersClass><a href="RunnersViewAllMain.php">All Runners</a></li>
			</ul>		
			<ul class="nav navbar-nav navbar-right">
				<li class="navbar-right"><a href="Logout.php">Logout</a></li>
