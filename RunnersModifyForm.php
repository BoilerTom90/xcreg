            ...
            <div class="panel panel-primary">
               ...
               <div class="panel-body">
                  <form class="form-horizontal" role="form" method="post" action="RunnersModifyHandler.php">
                     ...
                     <input type="hidden" id="runner_id" name="runner_id" value=<?php echo "\"" . $runner_id . "\"" ?>>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                           <input type="text" class="form-control" id="first_name" name="first_name" placeholder="First Name" value=<?php echo "\"" . $first_name . "\"" ?> title="Enter First Name" pattern="[A-Za-z0-9 -\.']{1,25}" data-toggle="popover" data-trigger="focus" data-content="Accepts up to 25 characters: alphanumeric, space, hyphen, or period." required>
                        </div>
                     </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                           <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Last Name" value=<?php echo "$last_name" ?> title="Enter Last Name" pattern="[A-Za-z0-9 -\.']{1,25}" data-toggle="popover" data-trigger="focus" data-content="Accepts up to 25 characters: alphanumeric, space, hyphen, or period." required>
                        </div>
                     </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                           <input type="number" class="form-control" min="3" max="8" id="grade" name="grade" placeholder="8" value=<?php echo "\"" . $grade . "\"" ?> title="Enter Grade" data-toggle="popover" data-trigger="focus" data-content="Accepts a number between 3 and 8" required>
                        </div>
                     </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                           <label class="radio-inline">
                              <input type="radio" name="sex" value="<?php echo RunnerSexValues::Boy ?>" <?php echo "$maleSelected" ?> required>Boy
                           </label>
                           <label class="radio-inline">
                              <input type="radio" name="sex" value="<?php echo RunnerSexValues::Girl ?>" <?php echo "$femaleSelected" ?> required>Girl
                           </label>
                        </div>
                     </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                           <select id="race_id" name="race_id" class="form-control" required>
                              <?php echo OutputRaceChoices(PHPSession::Instance()->GetSessionVariable('event_id'), $race_id); ?>
                           </select>
                        </div>
                     </div>
                     ...
                     <!-- <div class="form-group">
                        ...
                        <div class="col-sm-9">
                           <label class="radio-inline">
                              <input type="radio" name="qual_time_or" value="<?php echo "1" ?>" required <?php echo $qt_or_yes ?>>Yes
                           </label>
                           <label class="radio-inline">
